...
картці/у списку задач. Далі по беклогу — realtime для команд / експорт xlsx /
налаштовувані Kanban-колонки (клієнтів свідомо пропустили). Оновлюй у міру появи коду.
