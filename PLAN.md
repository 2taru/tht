...
- [ ] **Швидкий ввід:** дублювати/повторити запис, копія дня/тижня
- [ ] **Мобільний:** швидкий ввід + перегляд
- [ ] **Білінг:** ставки по проєкту/клієнту, суми до оплати
- [ ] **Клієнти:** рівень client → projects
- [ ] **Імпорт з Excel** існуючих годин/задач
- [ ] **Сповіщення/нагадування**
- [ ] Експорт Excel (xlsx); налаштовувані Kanban-колонки; exclusion вже є
...
- Чи потрібен «довільний діапазон» у звітах в MVP, чи лише день/тиждень/місяць.
